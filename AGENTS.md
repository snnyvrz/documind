...
- All durable quota transactions acquire the owner usage row before reservation rows. Recovery, admission, commitment, and release must preserve this order and recheck reservation state after locking it, preventing startup recovery from deadlocking with answer completion.
