...
func (x *AnswerEvent) GetDone() bool {
	if x != nil {
		return x.Done
	}
	return false
...
const file_proto_extractor_proto_rawDesc = "" +
	"\n" +
	"\x15proto/extractor.proto\x12\textractor\"C\n" +
	...
	"batchIndex\x12(\n" +
	"\x06chunks\x18\x02 \x03(\v2\x10.extractor.ChunkR\x06chunks\"\xcb\x01\n" +
	"\x05Chunk\x12\x14\n" +
	...
	"\tembedding\x18\x05 \x03(\x02R\tembedding\x12\x1d\n" +
	"\n" +
	"page_start\x18\x06 \x01(\rR\tpageStart\x12\x19\n" +
	"\bpage_end\x18\a \x01(\rR\apageEnd\"*\n" +
	...
	"\bcontexts\x18\x02 \x03(\v2\x18.extractor.AnswerContextR\bcontexts\"~\n" +
	"\rAnswerContext\x12\x1f\n" +
	"\vchunk_index\x18\x01 \x01(\rR\n" +
	"chunkIndex\x12\x12\n" +
	"\x04text\x18\x02 \x01(\tR\x04text\x12\x1d\n" +
	"\n" +
	"page_start\x18\x03 \x01(\rR\tpageStart\x12\x19\n" +
	"\bpage_end\x18\x04 \x01(\rR\apageEnd\"5\n" +
	"\vAnswerEvent\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x12\n" +
	"\x04done\x18\x02 \x01(\bR\x04done2\xf6\x01\n" +
...
var (
	...
	file_proto_extractor_proto_rawDescData []byte
)

func file_proto_extractor_proto_rawDescGZIP() []byte {
	file_proto_extractor_proto_rawDescOnce.Do(func() {
		file_proto_extractor_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_extractor_proto_rawDesc), len(file_proto_extractor_proto_rawDesc)))
	})
	return file_proto_extractor_proto_rawDescData
}

var file_proto_extractor_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_extractor_proto_goTypes = []any{
...
func file_proto_extractor_proto_init() {
	...
	file_proto_extractor_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_extractor_proto_rawDesc), len(file_proto_extractor_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
