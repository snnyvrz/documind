    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 py-12">
      ...
      <div className="grid w-full max-w-5xl overflow-hidden border bg-card shadow-2xl shadow-primary/5 md:grid-cols-[1.05fr_.95fr]">
        <div className="hidden min-h-[560px] flex-col justify-between bg-primary p-10 text-primary-foreground md:flex">
          ...
          <div>
            <p className="mb-4 max-w-sm text-4xl font-semibold tracking-tight">
              Turn dense pages into clear answers.
            </p>
            <p className="max-w-sm text-primary-foreground/70">
              Upload once. Search the source. Ask better questions.
            </p>
          </div>
          <p className="text-xs text-primary-foreground/60">
            Private by default · Built for focused reading
          </p>
        </div>
        <div className="flex min-h-[560px] flex-col justify-center p-8 sm:p-12">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-md text-sm leading-6 text-muted-foreground">
              {isRegister
                ? "Create an account to keep your uploads and answers private."
          ...
          <form className="space-y-4" onSubmit={submit}>
            <label className="block space-y-2 text-sm font-medium">
              Email
              <input
                className="flex h-10 w-full rounded-md border bg-background px-3 font-normal outline-none focus:ring-2 focus:ring-primary"
                type="email"
                autoComplete="email"
                required
                value={email}
            ...
            <button
              className="inline-flex h-10 w-full items-center justify-center rounded-2xl bg-primary px-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/80 disabled:cursor-not-allowed disabled:opacity-60"
              disabled={submitting}
              type="submit"
            >
              {submitting
